      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex flex-col text-sm w-1/3 items-end">
          <span className="flex">
            ...
            <span className="hidden sm:block mr-1">Humidity: </span>
            {`${humidity.toFixed()}%`}{" "}
          </span>
          <span className="mt-1 flex">
            <FontAwesomeIcon icon={faWind} className="mr-1" />
            <span className="hidden sm:flex  mr-1"> Wind Speed:</span>{" "}
            {`${speed.toFixed()} km/h`}
          </span>
        </div>
      </div>
      <div className="flex flex-row items-center  space-x-2e text-sm py-3  flex-wrap">
        <div className="flex flex-row items-center sm:justify-between sm:w-1/2 w-full">
          ...
          <div className="flex items-center">
            <FontAwesomeIcon icon={faSun} className=" pr-1" />
        ...
        <div className="flex items-center  md:w-1/2 justify-center">
          ...
          <p className="font-light mx-2 sm:mx-0">|</p>
          <div className="flex items-center md:w-1/2 justify-center">
          <FontAwesomeIcon icon={faArrowDown} className="pr-1" />
          <p className="font-light">
            Low:{" "}
